    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center" style={{ overflowX: 'clip' }}>
      ...
      >
        ...
        <motion.div variants={fadeUp} className="mb-4">
          <h1 className="font-display shimmer-text" style={{ fontSize: 'clamp(1.6rem, 5.5vw, 3.5rem)', lineHeight: 1.5, letterSpacing: '0.02em', textShadow: '0 0 20px rgba(0,0,0,0.6)', wordBreak: 'break-word' as const, padding: '0.15em 0' }}>
